...
class AboutIteration < EdgeCase::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # Takes an initial argument, which is given the first label in the block's variables list,
    # and is assigned the value of running the block in each iteration. i.e. it provides a local
    # accumulator within an 'each' block.
  end
  ...
  # Doing it this way ensures the inner block actions are only run if opening returned true, i.e. successfully.
