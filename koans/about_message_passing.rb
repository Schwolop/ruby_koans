...
class AboutMessagePassing < EdgeCase::Koan
  ...
  def test_catching_messages_makes_respond_to_lie # I think this is badly phrased - IMHO respond_to? is 
                                                  # telling the truth because catcher doesn't *really*
                                                  # respond to .any_method()
    catcher = AllMessageCatcher.new
